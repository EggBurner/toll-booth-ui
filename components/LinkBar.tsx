...
const LinkBar = () => {
  return (
    <form className='border w-full sm:w-[90%] lg:w-[70%] xl:w-[60%] 2xl:w-[50%] mx-auto flex items-center justify-between px-2 py-2 mt-8'>
        ...
        <button className='bg-black text-background px-2 py-2 text-xs sm:px-6 sm:py-2 sm:text-base rounded-xs shrink-0'>Generate Link - It's free</button>
    </form>
