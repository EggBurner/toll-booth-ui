...
const Hero = () => {
  return (
    <div className='text-center mt-20 w-[70%] mx-auto font-standard'>
        <p className='text-sm font-bold tracking-wider'>SIMPLIFY YOUR LINKS</p>
        <h1 className='text-6xl font-headline font-semibold mt-4'>Transform Long Urls, into Tiny Links Instantly!</h1>
        <h2 className='mt-8 text-lg w-[80%] mx-auto'>Shorten long URLs, track performance, & manage all your links in one place.
        Your go to solution for smarter sharing. Paste your long link below.</h2>
        <LinkBar />
        <div className='mx-auto w-[40%] mt-4 flex items-center justify-center gap-2'>
